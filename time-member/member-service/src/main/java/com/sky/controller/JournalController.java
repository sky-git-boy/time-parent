...
public class JournalController {
     ...
     */
    @PostMapping("/add")
    @Log(title = "添加个人反省", businessType = BusinessType.INSERT, operatorType = OperatorType.MEMBER)
     ...
     */
    @PutMapping("/update")
    @Log(title = "修改个人反省", businessType = BusinessType.UPDATE, operatorType = OperatorType.MEMBER)
