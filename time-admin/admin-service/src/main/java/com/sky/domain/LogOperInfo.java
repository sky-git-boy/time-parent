 ...
 */
@ApiModel(value = "com-sky-domain-LogOperInfo")
@Data
@EqualsAndHashCode(callSuper = true)
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "log_oper_info")
public class LogOperInfo extends BaseEntity {
    /**
     * 日志主键
     */
    ...
    @ApiModelProperty(value = "操作类别（0其它 1后台用户 2前台用户）")
    private String operatorType;

    /**
     * 操作人员
     */
    @TableField(value = "oper_by")
    ...
    public static final String COL_OPER_BY = "oper_by";
